    ...
    <div class="container">
        ...
        <form action="{{ route('battery-settings.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="longterm_target_price_cents" id="longterm_target_price_cents" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="longterm_target_electric_price_cents" id="longterm_target_electric_price_cents" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" required>
                    <option value="prioritize_charging">Prioritize Charging</option>
                    <option value="prioritize_selling">Prioritize Selling</option>
