...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Battery New Dashboard</h1>
        <button id="predict-prices-btn" class="btn btn-primary">Predict Prices</button>
    </div>

    @if(!($battery->forced_discharge) && !($battery->forced_charge))
        <div class="p-4 mb-4 rounded bg-info-subtle text-dark">
            <h2>Storing Solar</h2>
            <p>You're powering your home and charging your battery with solar.</p>
        </div>
    @elseif($battery->forced_discharge)
        <div class="p-4 mb-4 rounded bg-success-subtle text-dark">
            <h2>Exporting Solar to the Grid</h2>
            <p>You are exporting solar to the grid.</p>
        </div>
    @elseif($battery->forced_charge)
        <div class="p-4 mb-4 rounded bg-danger-subtle text-dark">
            <h2>Importing Electricity from the Grid</h2>
            <p>You are importing electricity from the grid.</p>
        </div>
    @endif
